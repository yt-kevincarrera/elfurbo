...
class Achievements {
  ...
  static final List<AchievementDef> all = [
    ...
    AchievementDef(
      ...
      emoji: '🎩',
      description: (t) =>
          'Mete 3 o más goles en un partido (${_n(t, 'vez', 'veces')}).',
    ...
    AchievementDef(
      ...
      title: 'Goleador',
      emoji: '⚽',
      description: (t) => 'Llega a $t goles confirmados.',
    ...
    AchievementDef(
      ...
      title: 'Asistidor',
      emoji: '🅰️',
      description: (t) => 'Llega a $t asistencias confirmadas.',
      thresholds: const [10, 50, 100],
      value: (s) => s.assists,
    ),
    AchievementDef(
    ...
    AchievementDef(
      ...
      title: 'Veterano',
      emoji: '🏟️',
      description: (t) => 'Juega $t partidos con el grupo.',
      thresholds: const [10, 50, 100],
      value: (s) => s.matchesPlayed,
    ),
    AchievementDef(
