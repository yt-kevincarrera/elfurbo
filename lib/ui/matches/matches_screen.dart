    ...
    return Scaffold(
      ...
      body: matchesAsync.when(
        ...
        data: (matches) {
          ...
          final played = matches.where((m) => !m.isUpcoming(now)).toList();
          return ListView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.groups, size: 18, color: scheme.onSurfaceVariant),
